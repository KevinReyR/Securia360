...
const statusCatalog: Record<string, StatusPresentation> = {
  ...
  resolved: { label: "Resuelta", tone: "success", explanation: "La oportunidad de mejora fue cerrada mediante una decisión autorizada." },
  ...
  not_met: { label: "No cumple", tone: "danger", explanation: "El criterio evaluado presenta una oportunidad de mejora." },
