...
export function StatusBanner({ status }: { status?: string }) {
  ...
  const messages: Record<string, { variant: "success" | "danger" | "warning"; text: string }> = {
    ...
    delivered: { variant: "success", text: "La entrega quedó registrada y el inventario fue actualizado." },
    accepted: { variant: "success", text: "La entrega quedó aceptada correctamente." },
    inspected: { variant: "success", text: "La inspección quedó registrada en el historial del elemento." },
    retired: { variant: "success", text: "El elemento fue retirado y se conservó su trazabilidad." },
    ...
    "stock-error": { variant: "danger", text: "No fue posible actualizar el inventario. Revisa la disponibilidad, la cantidad y la ubicación." },
    "evidence-error": { variant: "danger", text: "No fue posible guardar la evidencia. Revisa el archivo y vuelve a intentarlo." },
    "acceptance-error": { variant: "danger", text: "No fue posible aceptar la entrega. Confirma que esté pendiente y asignada a tu usuario." },
