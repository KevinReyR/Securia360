...
const messages: Record<string, { variant: "success" | "danger" | "warning"; text: string }> = {
  ...
  "gap-closed": { variant: "success", text: "La oportunidad de mejora se cerró con validación y trazabilidad." },
  ...
  "verification-required": { variant: "danger", text: "Debes validar al menos una acción antes de cerrar la oportunidad de mejora." },
  "gap-already-closed": { variant: "warning", text: "La oportunidad de mejora ya se encuentra cerrada." },
