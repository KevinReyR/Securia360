...
export type CopilotSource = { source_type: "document_version"|"normative_source_version"|"requirement"|"assessment"|"risk"|"task"; source_id: string; source_version_id?: string; source_label: string; excerpt: string; source_snapshot: Record<string, unknown> };
